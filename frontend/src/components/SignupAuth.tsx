...
import { type SignupInputs } from "@resok/medium-common";
...
export const SignupAuth = () => {
    ...
    async function handleSubmit() {
        try {
            ...
            const message = e.response?.data?.message || e.response?.data?.error || "Error while signing up. Please try again.";
            toast.error(message);
        } finally {
            setLoading(false)
        }
    ...
    return (
        <div className="flex min-h-screen items-center justify-center">
            <div className="w-full max-w-md px-8">
                <h1 className="text-3xl text-center font-extrabold mb-2 px-10"> Create an account </h1>
